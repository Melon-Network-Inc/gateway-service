...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/account/completeWalletCreation": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "description": "Complete wallet creation",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Complete wallet creation",
                "operationId": "complete-wallet-creation",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Authorization",
        ...
        "/auth/google/openIdConnect": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Open ID Connect request contains the id token and device informaton.",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.OpenIDConnectRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "cannot extract correct user information from auth token",
                        "schema": {
                            "type": "string"
                        }
                    },
